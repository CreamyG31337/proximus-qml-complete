...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Wed Dec 28 13:00:37 2011
# Project:  Proximus-complete.pro
# Template: subdirs
# Command: z:/qtsdk/madde/targets/harmattan_10.2011.34-1/bin/qmake.exe -spec ../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/share/qt4/mkspecs/default -unix -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc -o Makefile Proximus-complete.pro
#############################################################################
...
Proximus/$(MAKEFILE): 
	...
	cd Proximus/ && $(QMAKE) z:/Qt/Proximus-complete/Proximus/Proximus.pro -spec ../../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/share/qt4/mkspecs/default -unix -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc -o $(MAKEFILE)
...
proximus-daemon/$(MAKEFILE): 
	...
	cd proximus-daemon/ && $(QMAKE) z:/Qt/Proximus-complete/proximus-daemon/proximus-daemon.pro -spec ../../../QtSDK/Madde/sysroots/harmattan_sysroot_10.2011.34-1_slim/usr/share/qt4/mkspecs/default -unix -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc -o $(MAKEFILE)
...
install_target2: FORCE
	...
	-$(INSTALL_FILE) z:/Qt/Proximus-complete/proximus-daemon.conf $(INSTALL_ROOT)/etc/init/apps/
